...
export default function SalesManagerCustomerCreatePage() {
  ...
  const customerActions = useCustomerActions({
    onSuccess: (payload) => {
      ...
      navigate(customerId ? `${ROUTES.SALES_MANAGER.CUSTOMERS}/${customerId}` : ROUTES.SALES_MANAGER.CUSTOMERS);
    },
  });
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-5">
        <CustomerForm
          cancelPath={ROUTES.SALES_MANAGER.CUSTOMERS}
          errors={errors}
