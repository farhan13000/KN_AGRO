...
export default function SuperAdminLeadCreatePage() {
  ...
  const leadActions = useLeadActions({
    onSuccess: (payload) => {
      ...
      navigate(leadId ? `${ROUTES.SUPER_ADMIN.LEADS}/${leadId}` : ROUTES.SUPER_ADMIN.LEADS);
    },
  });
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted">
          Add a lead the team has found. The lead code, its starting status and who it belongs to are set for you.
        </p>
      </div>
      ...
      <Card className="p-5">
        <LeadForm
          cancelTo={ROUTES.SUPER_ADMIN.LEADS}
          errors={errors}
